  ...
  return (
    <main className="legal-page">
      ...
      <article className="site-shell legal-content">
        ...
        <p className="legal-updated">最后更新：2026-09-24</p>
        ...
        <h2>可选第一方产品分析</h2>
        <p>同意后，我们使用随机浏览器或安装标识记录页面与课程访问、清洗后的来源渠道、国家级网络出口地区、有效播放区间、练习行为类型和媒体质量。分析不复制听写、笔记正文、完整来源网址、原始 IP 或硬件标识。网络地区不代表国籍或常住地。你可以随时在页面或应用内关闭可选分析；拒绝不会影响账号、进度和学习功能。注册请求的网络地区及必要安全日志与可选学习遥测分开处理。</p>
        <p>原始分析事件保留90天，分析会话和用户日事实最长13个月。关闭分析停止新采集并清理本地队列；删除账号同时删除分析事件、会话、分析属性和用户日事实中的账号关联。运营汇总仅供受限管理员访问。</p>
        <h2>数据共享与第三方服务</h2>
