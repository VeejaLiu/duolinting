  ...
  return (
    <main className="legal-page">
      ...
      <article className="site-shell legal-content">
        ...
        <h2>第一方产品分析</h2>
        <p>我们使用随机浏览器或安装标识记录页面与课程访问、清洗后的来源渠道、国家级网络出口地区、有效播放区间、练习行为类型和媒体质量。分析不复制听写、笔记正文、完整来源网址、原始 IP 或硬件标识。网络地区不代表国籍或常住地。产品分析默认在后台运行，不设置采集授权提示或采集开关。注册请求的网络地区及必要安全日志与可选学习遥测分开处理。</p>
