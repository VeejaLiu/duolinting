...
const lastUpdated = new Date("2026-08-29T00:00:00.000Z");
...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    { url: officialSiteHref("/support"), lastModified: lastUpdated, changeFrequency: "yearly", priority: 0.7 },
    ...
    { url: officialSiteHref("/en/support"), lastModified: lastUpdated, changeFrequency: "yearly", priority: 0.6 },
